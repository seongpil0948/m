    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.CharField(help_text='날짜별 주식시세', max_length=50, primary_key=True, serialize=False, unique=True)),
                ('diff', models.IntegerField()),
                ('volume', models.IntegerField()),
                ('code', models.ForeignKey(help_text='회사 종목 코드', on_delete=django.db.models.deletion.CASCADE, to='stock.company')),
            ],
            options={
                'abstract': False,
            },
